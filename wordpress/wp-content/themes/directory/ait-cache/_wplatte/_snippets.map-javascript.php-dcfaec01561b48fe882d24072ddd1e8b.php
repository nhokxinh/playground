<?php //netteCache[01]000480a:2:{s:4:"time";s:21:"0.95910300 1374053892";s:9:"callbacks";a:3:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:91:"/home/tgud/tgud.com.vn/pg/wp-content/themes/directory/Templates/snippets/map-javascript.php";i:2;i:1374053480;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"eee17d5 released on 2011-08-13";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:21:"WPLATTE_CACHE_VERSION";i:2;i:4;}}}?><?php

// source file: /home/tgud/tgud.com.vn/pg/wp-content/themes/directory/Templates/snippets/map-javascript.php

?><?php list($_l, $_g) = NCoreMacros::initRuntime($template, 'm0jrg92oef')
;
// snippets support
...
<script type="text/javascript">
	...
	jQuery(document).ready(function($) {
			...
			map = mapDiv.height(<?php echo $themeOptions->directoryMap->mapHeight ?>).gmap3({
				map: {
					options: {
...
<?php if ($isGeolocation && (isset($_GET['geo-lat'])) && (isset($_GET['geo-lng'])) && (isset($_GET['geo-radius']))): ?>
		    generateOnlyGeo(<?php echo NTemplateHelpers::escapeJs($_GET['geo-lat']) ?>
,<?php echo NTemplateHelpers::escapeJs($_GET['geo-lng']) ?>,<?php echo NTemplateHelpers::escapeJs($_GET['geo-radius']) ?>);
<?php endif ?>
		
		mapCenter = map.getCenter();
		mapZoom = map.getZoom();

<?php NCoreMacros::includeTemplate('ajaxfunctions-javascript.php', $template->getParams(), $_l->templates['m0jrg92oef'])->render() ?>
