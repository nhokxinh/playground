<?php //netteCache[01]000478a:2:{s:4:"time";s:21:"0.84569600 1372070633";s:9:"callbacks";a:3:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:89:"/Users/longlc/Sites/playground/wordpress/wp-content/themes/directory/Templates/header.php";i:2;i:1372069800;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"eee17d5 released on 2011-08-13";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:21:"WPLATTE_CACHE_VERSION";i:2;i:4;}}}?><?php

// source file: /Users/longlc/Sites/playground/wordpress/wp-content/themes/directory/Templates/header.php

?><?php list($_l, $_g) = NCoreMacros::initRuntime($template, '8uu7p0wgom')
;
// snippets support
...
<?php if ($themeOptions->fonts->fancyFont->type == 'google'): ?>
        <link href="http://fonts.googleapis.com/css?family=<?php echo htmlSpecialChars($themeOptions->fonts->fancyFont->font) ?>&subset=vietnamese" rel="stylesheet" type="text/css" />
<?php endif ?>
...
<?php if(is_singular() && get_option("thread_comments")){wp_enqueue_script("comment-reply");}wp_head() ?>
        ...
        jQuery(document).ready(function($) {
			...
			<?php function add_sub_term($list,$term,$prefix){
				...
				return $str_sub;
			}$iterations = 0; foreach ($iterator = $_l->its[] = new NSmartCachingIterator($categories) as $cat): if ($cat->parent == 0): ?>
					...
					<?php echo add_sub_term($categories,$cat,'-') ?>

<?php endif ;$iterations++; endforeach; array_pop($_l->its); $iterator = end($_l->its) ?>
            ];
            var locations = [
<?php $iterations = 0; foreach ($iterator = $_l->its[] = new NSmartCachingIterator($locations) as $loc): if ($loc->parent == 0): ?>
...
,<?php endif ?>
					...
					<?php echo add_sub_term($locations,$loc,'-') ?>
...
<?php NCoreMacros::includeTemplate('snippets/social-icons.php', $template->getParams(), $_l->templates['8uu7p0wgom'])->render() ;NCoreMacros::includeTemplate('snippets/wpml-flags.php', $template->getParams(), $_l->templates['8uu7p0wgom'])->render() ?>
                            <!-- <?php NCoreMacros::includeTemplate('snippets/search-form.php', $template->getParams(), $_l->templates['8uu7p0wgom'])->render() ?> -->
                        </div>
                    </div>
<?php endif ?>
            </div>
...
<?php if (isset($isDirSingle)): NCoreMacros::includeTemplate('snippets/map-single-javascript.php', $template->getParams(), $_l->templates['8uu7p0wgom'])->render() ;else: if ($headerType == 'map'): NCoreMacros::includeTemplate('snippets/map-javascript.php', $template->getParams(), $_l->templates['8uu7p0wgom'])->render() ;endif ;endif ?>
...
<?php endif ?>
                                ...
                                <input type="text" id="dir-searchinput-category" placeholder="<?php echo htmlSpecialChars(__('Nhóm địa điểm', 'ait')) ?>" />
